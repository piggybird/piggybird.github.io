---
layout:     post
title:      "WriteHat GrandPrix Qual: Hue"
...
## Key generation ##
Here are the key and flag generated by our [Python Scrypt]({{ site.url }}/downloads/ctf/whitehat_qual_2015_re450_gen.py){:target="_blank"}:
